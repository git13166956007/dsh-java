...
| Sub-agents | Persisted sub-agent profiles with independent model/mode/prompt, tool and Skill allowlists; plan steps and active Agents can dispatch enabled execution workers; adaptive planner selects or explicitly creates workers | Richer adaptive delegation policies and cost-aware routing |
